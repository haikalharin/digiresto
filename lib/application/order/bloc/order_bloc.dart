        ...
        await event.map(
          getOutletByLocation: (request) async {
            ...
            final getOutletByLocation =
                await _orderRepository.getOutletByLocation(request.request
                    .copyWith(queryString: queryString)
                    .toJson());
          ...
          getOutletByCategory: (request) async {
            ...
            final getOutletByCategory =
                await _orderRepository.getOutletByCategory(request.request
                    .copyWith(queryString: queryString)
                    .toJson());
          ...
          getOutletProductCategory: (request) async {
            emit(OrderState.loadInProgress());
            final getOutletProductCategory = await _orderRepository
                .getOutletProductCategory(request.request);
          ...
          getDigiDiscountOutlet: (request) async {
            ...
            emit(getPromoOutlet.fold(
              (error) => OrderState.loadFailure(
                  OrderFailure.getPromoOutletFail(error)),
          ...
          getPaymentMethod: (request) async {
            emit(OrderState.loadInProgress());
            final getPaymentMethod = await _orderRepository
                .getPaymentMethod(request.request.toJson());
          ...
          deliveryInquiry: (r) async {
            ...
            emit(deliveryInquiry.fold(
              (error) => OrderState.loadFailure(
                  OrderFailure.deliveryInquiryFail(error)),
          ...
          checkVoucherOutlet: (request) async {
            ...
            final getSalesTypeCart =
                await _orderRepository.getSalesTypeCartID();
            final getDineInID = await _orderRepository.getDineInIDMethod();
            final getDriveThruID =
                await _orderRepository.getDriveThruIDMethod();
          ...
          addCart: (request) async {
            ...
            final activeAddr = address.getOrElse(() => UserAddress());
            final deliveryInq =
                await _orderRepository.setDeliveryMethodID(null);
            final getVoucherMethodID =
            ...
            if (sessionId == null || outletID != request.outlet.id) {
              final createCartSession = await _orderRepository
                  .createCartSession(CreateCartSessionParam(
              ...
              final createCartSession = await _orderRepository
                  .updateCartSession(UpdateCartSessionParam(
                      body: UpdateCartSessionBodyParam(
                        items: setProduct?.items ?? [],
                        customerNote: null,
                        paymentType: paymentType?.id ?? "",
          ...
          reorderCart: (r) async {
            ...
            if (dataCart != null) {
              await _orderRepository
                  .setSalesTypeCartID(r.request.body.salesType);
          ...
          removeCart: (r) async {
            ...
            if (removeCart == null || sessionId == null) {
              ...
              final createCartSession =
                  await _orderRepository.updateCartSession(
                UpdateCartSessionParam(
                  body: UpdateCartSessionBodyParam(
          ...
          getDineInIDMethod: (r) async {
            emit(OrderState.loadInProgress());
            final getDineInIDMethod =
                await _orderRepository.getDineInIDMethod();
          ...
          setDriveThruIDMethod: (r) async {
            ...
            if (setDriveThruIDMethod != null) {
              emit(
                  OrderState.setDriveThruIDMethodSuccess(setDriveThruIDMethod));
            } else {
              emit(OrderState.loadFailure(
          ...
          cancelTransaction: (r) async {
            ...
            final cancelTransaction =
                await _profileRepository.cancelTransaction(
          ...
          getDetailOutletByMerchant: (request) async {
            ...
            emit(
              getDetailOutletByMerchant.fold(
                ...
                (list) =>
                    OrderState.getDetailOutletByMerchantSuccess(list.data),
              ),
            );
          },
        );
