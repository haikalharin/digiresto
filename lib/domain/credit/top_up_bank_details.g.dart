...
_$_TopUpBankDetails _$_$_TopUpBankDetailsFromJson(Map<String, dynamic> json) {
  return _$_TopUpBankDetails(
...
Map<String, dynamic> _$_$_TopUpBankDetailsToJson(
        _$_TopUpBankDetails instance) =>
    <String, dynamic>{
      'formattedTransactionDate':
