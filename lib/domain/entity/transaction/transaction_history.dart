import 'package:digiresto/domain/entity/outlet/outlet.dart';
import 'package:digiresto/domain/entity/transaction/transaction_history_item.dart';
...
class TransactionHistory {
  ...
  factory TransactionHistory.createTransactionHistory(
    ...
    return TransactionHistory(
      ...
      items: List<TransactionHistoryItem>.from(
          object['items'].map((data) => TransactionHistoryItem.create(data))),
      ...
      taxesAndServices: List<TransactionHistoryTaxesAndServices>.from(
          object['taxesAndServices']
              .map((data) => TransactionHistoryTaxesAndServices.create(data))),
