...
_$_UpdateCartSessionParam _$$_UpdateCartSessionParamFromJson(
        Map<String, dynamic> json) =>
    _$_UpdateCartSessionParam(
...
Map<String, dynamic> _$$_UpdateCartSessionParamToJson(
...
_$_UpdateCartSessionBodyParam _$$_UpdateCartSessionBodyParamFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$_UpdateCartSessionBodyParamToJson(
...
_$_UpdateCartSessionBodyDeliveryParam
    _$$_UpdateCartSessionBodyDeliveryParamFromJson(Map<String, dynamic> json) =>
        _$_UpdateCartSessionBodyDeliveryParam(
...
Map<String, dynamic> _$$_UpdateCartSessionBodyDeliveryParamToJson(
...
_$_UpdateCartSessionQueryParam _$$_UpdateCartSessionQueryParamFromJson(
        Map<String, dynamic> json) =>
    _$_UpdateCartSessionQueryParam(
      sessionId: json['sessionId'] as String,
    );

Map<String, dynamic> _$$_UpdateCartSessionQueryParamToJson(
