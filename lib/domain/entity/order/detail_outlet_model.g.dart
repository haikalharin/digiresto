...
_$_DetailOutletResponse _$_$_DetailOutletResponseFromJson(
    Map<String, dynamic> json) {
  return _$_DetailOutletResponse(
    response: StatusResponse.fromJson(json['response'] as Map<String, dynamic>),
    data:
        DetailOutletDataResponse.fromJson(json['data'] as Map<String, dynamic>),
    meta: MetaResponse.fromJson(json['meta'] as Map<String, dynamic>),
  );
}

Map<String, dynamic> _$_$_DetailOutletResponseToJson(
...
_$_DetailOutletDataResponse _$_$_DetailOutletDataResponseFromJson(
    Map<String, dynamic> json) {
  return _$_DetailOutletDataResponse(
...
Map<String, dynamic> _$_$_DetailOutletDataResponseToJson(
...
_$_DetailOutletDataLastUpdateResponse
    _$_$_DetailOutletDataLastUpdateResponseFromJson(Map<String, dynamic> json) {
  return _$_DetailOutletDataLastUpdateResponse(
    time: json['time'] as String,
    literal: json['literal'] as String,
  );
}

Map<String, dynamic> _$_$_DetailOutletDataLastUpdateResponseToJson(
