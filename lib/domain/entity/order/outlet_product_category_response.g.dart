...
_$_OutletProductCategoryResponse _$$_OutletProductCategoryResponseFromJson(
...
Map<String, dynamic> _$$_OutletProductCategoryResponseToJson(
...
_$_OutletProductCategoryDataResponse
    _$$_OutletProductCategoryDataResponseFromJson(Map<String, dynamic> json) =>
        _$_OutletProductCategoryDataResponse(
          id: json['id'] as int,
...
Map<String, dynamic> _$$_OutletProductCategoryDataResponseToJson(
...
_$_OutletProductMetaResponse _$$_OutletProductMetaResponseFromJson(
        Map<String, dynamic> json) =>
    _$_OutletProductMetaResponse(
      version: json['version'] as String,
    );

Map<String, dynamic> _$$_OutletProductMetaResponseToJson(
...
_$_OutletProductCategoryStatusResponse
    _$$_OutletProductCategoryStatusResponseFromJson(
            Map<String, dynamic> json) =>
        _$_OutletProductCategoryStatusResponse(
          code: json['code'] as String,
...
Map<String, dynamic> _$$_OutletProductCategoryStatusResponseToJson(
