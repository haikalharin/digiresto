...
_$_GetListVoucherOutletResponse _$$_GetListVoucherOutletResponseFromJson(
        Map<String, dynamic> json) =>
    _$_GetListVoucherOutletResponse(
      response:
...
Map<String, dynamic> _$$_GetListVoucherOutletResponseToJson(
...
_$_GetListVoucherOutletDataResponse
    _$$_GetListVoucherOutletDataResponseFromJson(Map<String, dynamic> json) =>
        _$_GetListVoucherOutletDataResponse(
          name: json['name'] as String,
          code: json['code'] as String,
        );

Map<String, dynamic> _$$_GetListVoucherOutletDataResponseToJson(
