...
abstract class $UserProfileCopyWith<$Res> {
  ...
  $Res call(
      ...
      String email,
      String mobilePhone,
      @JsonKey(name: 'hidden_pushid') String hiddenPushId});
}
...
class _$_UserProfile implements _UserProfile {
  const _$_UserProfile(
      ...
      @JsonKey(name: 'hidden_pushid') required this.hiddenPushId});
  ...
  @override
  String toString() {
    return 'UserProfile(id: $id, name: $name, username: $username, email: $email, mobilePhone: $mobilePhone, hiddenPushId: $hiddenPushId)';
  }
