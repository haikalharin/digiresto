...
abstract class $UserProfileCopyWith<$Res> {
  ...
  $Res call(
      {int id, String name, String username, String email, String mobilePhone});
}
...
class _$_UserProfile implements _UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(id: $id, name: $name, username: $username, email: $email, mobilePhone: $mobilePhone)';
  }
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile(
      ...
      required String username,
      required String email,
      required String mobilePhone}) = _$_UserProfile;
