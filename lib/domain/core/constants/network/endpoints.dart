...
class Endpoints {
  ...
  static const String urlMenuCategory = '/menu/category?version=1.5.9';
  ...
  static const Map<String, dynamic> urlGetDetailOutletByMerchant = {
    "r": "v2/getdetailoutletbymerchant"
  };
}
