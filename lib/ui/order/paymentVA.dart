            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text('Silahkan lanjutkan proses pembayaran dengan detail sebagai berikut'),
                ],
              ),
            ),
            SizedBox(height: 10),
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(vaPayment['title'],
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                          SizedBox(height: 5),
                          Text(vaPayment['vaNumber'],
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: AppColors.red,
                            ),
                      ...
                      FlatButton(
                        onPressed: () {
                          Clipboard.setData(ClipboardData(text: vaPayment['vaNumber']));
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5),
                          Text(Rupiah.format(vaPayment['amount'].toString()),
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                      ...
                      FlatButton(
                        onPressed: () {
                          Clipboard.setData(ClipboardData(text: vaPayment['amount'].toString()));
