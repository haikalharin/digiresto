            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Image(
                    image: AssetImage(Assets.bgOnbooarding2),
                    fit: BoxFit.cover,
                    alignment: Alignment.center,
                  ),
                ),
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Icon(Icons.fiber_manual_record, color: AppColors.yellow, size: 20),
                            Icon(Icons.fiber_manual_record, color: Colors.white, size: 20),
                      ...
                      SizedBox(
                        ...
                        width: 110,
                        child: RaisedButton(
                            onPressed: () {Navigator.of(context).pushReplacementNamed(Routes.onboarding_favorite);},
