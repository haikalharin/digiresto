...
import 'application/auth/login/login_bloc.dart' as _i37;
import 'application/auth/register/register_bloc.dart' as _i38;
import 'application/auth/validate_otp/validate_otp_bloc.dart' as _i39;
...
import 'infrastructure/core/register_module.dart' as _i41;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i37.LoginBloc>(() => _i37.LoginBloc(get<_i35.IAuthFacade>()));
  gh.factory<_i38.RegisterBloc>(
      () => _i38.RegisterBloc(get<_i35.IAuthFacade>()));
  gh.factory<_i39.ValidateOtpBloc>(
      () => _i39.ValidateOtpBloc(get<_i35.IAuthFacade>(), get<_i11.Logger>()));
  gh.factory<_i40.AuthBloc>(() => _i40.AuthBloc(get<_i35.IAuthFacade>()));
  return get;
}
