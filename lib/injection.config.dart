...
import 'application/address/list/address_list_bloc.dart' as _i34;
import 'application/address/map/address_map_bloc.dart' as _i35;
...
import 'application/auth/validate_otp/validate_otp_bloc.dart' as _i49;
import 'application/core/app_bloc.dart' as _i19;
import 'application/credit/credit_bloc.dart' as _i52;
...
import 'application/credit/waiting_payment/waiting_payment_bloc.dart' as _i50;
import 'application/home/home_user_bloc/home_user_bloc.dart' as _i38;
import 'application/order/bloc/order_bloc.dart' as _i44;
import 'application/transaction/bloc/transaction_bloc/transaction_bloc.dart'
    as _i48;
import 'domain/auth/i_auth_facade.dart' as _i39;
...
import 'domain/credit/i_credit_repository.dart' as _i41;
import 'infrastructure/auth/api_auth_facade.dart' as _i40;
...
import 'infrastructure/credit/credit_repository.dart' as _i42;
import 'infrastructure/network/apis/auth/auth_api.dart' as _i36;
import 'infrastructure/network/apis/auth/auth_repository.dart' as _i37;
...
import 'infrastructure/network/apis/transaction/transaction_repository.dart'
    as _i31;
import 'infrastructure/network/apis/user/user_api.dart' as _i32;
import 'infrastructure/network/apis/user/user_local.dart' as _i18;
import 'infrastructure/network/apis/user/user_repository.dart' as _i33;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i31.TransactionRepository>(
      () => _i31.TransactionRepository(get<_i30.TransactionApi>()));
  gh.factory<_i32.UserApi>(
      () => _i32.UserApi(get<_i23.INetworkService>(), get<_i15.IStorage>()));
  gh.factory<_i33.UserRepository>(
      () => _i33.UserRepository(get<_i32.UserApi>(), get<_i18.UserLocal>()));
  gh.factory<_i34.AddressListBloc>(() => _i34.AddressListBloc(
      get<_i33.UserRepository>(), get<_i26.MapRepository>()));
  gh.factory<_i35.AddressMapBloc>(() => _i35.AddressMapBloc(
      get<_i33.UserRepository>(), get<_i26.MapRepository>()));
  gh.factory<_i36.AuthApi>(() => _i36.AuthApi(get<_i23.INetworkService>()));
  gh.factory<_i37.AuthRepository>(
      () => _i37.AuthRepository(get<_i36.AuthApi>()));
  gh.factory<_i38.HomeUserBloc>(() => _i38.HomeUserBloc(
      get<_i33.UserRepository>(), get<_i28.OrderRepository>()));
  gh.lazySingleton<_i39.IAuthFacade>(() => _i40.ApiAuthFacade(
      get<_i23.INetworkService>(), get<_i13.Logger>(), get<_i15.IStorage>()));
  gh.lazySingleton<_i41.ICreditRepository>(() =>
      _i42.CreditRepository(get<_i23.INetworkService>(), get<_i13.Logger>()));
  gh.factory<_i43.LoginBloc>(() => _i43.LoginBloc(get<_i39.IAuthFacade>()));
  gh.factory<_i44.OrderBloc>(() =>
      _i44.OrderBloc(get<_i28.OrderRepository>(), get<_i33.UserRepository>()));
  gh.factory<_i45.RecentHistoryBloc>(
      () => _i45.RecentHistoryBloc(get<_i41.ICreditRepository>()));
  gh.factory<_i46.RegisterBloc>(
      () => _i46.RegisterBloc(get<_i39.IAuthFacade>()));
  gh.factory<_i47.TopUpCreditBloc>(() => _i47.TopUpCreditBloc(
      get<_i41.ICreditRepository>(), get<_i15.IStorage>()));
  gh.factory<_i48.TransactionBloc>(
      () => _i48.TransactionBloc(get<_i31.TransactionRepository>()));
  gh.factory<_i49.ValidateOtpBloc>(
      () => _i49.ValidateOtpBloc(get<_i39.IAuthFacade>(), get<_i13.Logger>()));
  gh.factory<_i50.WaitingPaymentBloc>(
      () => _i50.WaitingPaymentBloc(get<_i41.ICreditRepository>()));
  gh.factory<_i51.AuthBloc>(() => _i51.AuthBloc(get<_i39.IAuthFacade>()));
  gh.factory<_i52.CreditBloc>(
      () => _i52.CreditBloc(get<_i41.ICreditRepository>()));
  return get;
}
