...
import 'application/auth/auth_bloc.dart' as _i62;
import 'application/auth/login/login_bloc.dart' as _i52;
import 'application/auth/register/register_bloc.dart' as _i57;
import 'application/auth/validate_otp/validate_otp_bloc.dart' as _i60;
import 'application/core/app_bloc.dart' as _i19;
import 'application/credit/credit_bloc.dart' as _i63;
import 'application/credit/recent_history/recent_history_bloc.dart' as _i56;
import 'application/credit/topup_credit/top_up_credit_bloc.dart' as _i58;
import 'application/credit/waiting_payment/waiting_payment_bloc.dart' as _i61;
import 'application/digi_locale/digi_locale_bloc.dart' as _i45;
import 'application/home/home_user_bloc/home_user_bloc.dart' as _i47;
import 'application/notification/notification_bloc.dart' as _i32;
import 'application/order/bloc/order_bloc.dart' as _i53;
import 'application/order/order_cart_screen_view_controller.dart' as _i54;
...
import 'application/profile/profile_bloc.dart' as _i55;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i47.HomeUserBloc>(() => _i47.HomeUserBloc(
      get<_i40.UserRepository>(), get<_i36.OrderRepository>()));
  ...
  gh.lazySingleton<_i50.ICreditRepository>(() =>
      _i51.CreditRepository(get<_i24.INetworkService>(), get<_i11.Logger>()));
  gh.factory<_i52.LoginBloc>(() => _i52.LoginBloc(get<_i48.IAuthFacade>()));
  gh.factory<_i53.OrderBloc>(() =>
      _i53.OrderBloc(get<_i36.OrderRepository>(), get<_i40.UserRepository>()));
  gh.factory<_i54.OrderCartScreenViewController>(
      () => _i54.OrderCartScreenViewController(get<_i36.OrderRepository>()));
  gh.factory<_i55.ProfileBloc>(() => _i55.ProfileBloc(get<_i48.IAuthFacade>()));
  gh.factory<_i56.RecentHistoryBloc>(
      () => _i56.RecentHistoryBloc(get<_i50.ICreditRepository>()));
  gh.factory<_i57.RegisterBloc>(
      () => _i57.RegisterBloc(get<_i48.IAuthFacade>()));
  gh.factory<_i58.TopUpCreditBloc>(() => _i58.TopUpCreditBloc(
      get<_i50.ICreditRepository>(), get<_i15.IStorage>()));
  gh.factory<_i59.TransactionBloc>(
      () => _i59.TransactionBloc(get<_i38.TransactionRepository>()));
  gh.factory<_i60.ValidateOtpBloc>(
      () => _i60.ValidateOtpBloc(get<_i48.IAuthFacade>(), get<_i11.Logger>()));
  gh.factory<_i61.WaitingPaymentBloc>(
      () => _i61.WaitingPaymentBloc(get<_i50.ICreditRepository>()));
  gh.factory<_i62.AuthBloc>(() => _i62.AuthBloc(
      get<_i48.IAuthFacade>(), get<_i26.INotificationRepository>()));
  gh.factory<_i63.CreditBloc>(
      () => _i63.CreditBloc(get<_i50.ICreditRepository>()));
  return get;
}
