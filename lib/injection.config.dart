...
import 'application/auth/login/login_bloc.dart' as _i55;
import 'application/auth/register/register_bloc.dart' as _i61;
import 'application/auth/validate_otp/validate_otp_bloc.dart' as _i64;
import 'application/core/app_bloc.dart' as _i20;
import 'application/credit/credit_bloc.dart' as _i68;
import 'application/credit/recent_history/recent_history_bloc.dart' as _i60;
import 'application/credit/topup_credit/top_up_credit_bloc.dart' as _i62;
import 'application/credit/waiting_payment/waiting_payment_bloc.dart' as _i65;
import 'application/digi_locale/digi_locale_bloc.dart' as _i45;
import 'application/home/home_user_bloc/home_user_bloc.dart' as _i70;
import 'application/home_new/bloc/home_bloc.dart' as _i69;
import 'application/home_new/outlet/outlet_bloc.dart' as _i58;
import 'application/landing/bottom_tab_cubit.dart' as _i67;
import 'application/notification/notification_bloc.dart' as _i33;
import 'application/order/bloc/order_bloc.dart' as _i56;
import 'application/order/order_cart_screen_view_controller.dart' as _i57;
...
import 'domain/home/i_home_repository.dart' as _i51;
import 'domain/notification/i_notification_repository.dart' as _i27;
import 'domain/order/i_order_repository.dart' as _i53;
...
import 'infrastructure/core/register_module.dart' as _i71;
...
import 'infrastructure/home/home_repository.dart' as _i52;
...
import 'infrastructure/order/order_api.dart' as _i34;
import 'infrastructure/order/order_local.dart' as _i18;
import 'infrastructure/order/order_repository.dart' as _i54;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i18.OrderLocal>(
      () => _i18.OrderLocal(get<_i16.IStorage>(), get<_i12.Logger>()));
  ...
  gh.lazySingleton<_i49.ICreditRepository>(() =>
      _i50.CreditRepository(get<_i25.INetworkService>(), get<_i12.Logger>()));
  gh.lazySingleton<_i51.IHomeRepository>(() => _i52.HomeRepository(
      get<_i12.Logger>(),
      get<_i25.INetworkService>(),
      get<_i16.IStorage>(),
      get<_i10.ILocationService>(),
      get<_i7.Env>()));
  gh.lazySingleton<_i53.IOrderRepository>(
      () => _i54.OrderRepository(get<_i34.OrderApi>(), get<_i18.OrderLocal>()));
  gh.factory<_i55.LoginBloc>(() => _i55.LoginBloc(get<_i47.IAuthFacade>()));
  gh.factory<_i56.OrderBloc>(() => _i56.OrderBloc(get<_i53.IOrderRepository>(),
      get<_i40.UserRepository>(), get<_i29.IProfileRepository>()));
  gh.factory<_i57.OrderCartScreenViewController>(
      () => _i57.OrderCartScreenViewController(get<_i53.IOrderRepository>()));
  gh.lazySingleton<_i58.OutletBloc>(
      () => _i58.OutletBloc(get<_i51.IHomeRepository>()));
  gh.factory<_i59.ProfileBloc>(() => _i59.ProfileBloc(get<_i47.IAuthFacade>()));
  gh.factory<_i60.RecentHistoryBloc>(
      () => _i60.RecentHistoryBloc(get<_i49.ICreditRepository>()));
  gh.factory<_i61.RegisterBloc>(
      () => _i61.RegisterBloc(get<_i47.IAuthFacade>()));
  gh.factory<_i62.TopUpCreditBloc>(() => _i62.TopUpCreditBloc(
      get<_i49.ICreditRepository>(), get<_i16.IStorage>()));
  gh.factory<_i63.TransactionBloc>(
      () => _i63.TransactionBloc(get<_i38.TransactionRepository>()));
  gh.factory<_i64.ValidateOtpBloc>(
      () => _i64.ValidateOtpBloc(get<_i47.IAuthFacade>(), get<_i12.Logger>()));
  gh.factory<_i65.WaitingPaymentBloc>(
      () => _i65.WaitingPaymentBloc(get<_i49.ICreditRepository>()));
  gh.factory<_i66.AuthBloc>(() => _i66.AuthBloc(
      get<_i47.IAuthFacade>(), get<_i27.INotificationRepository>()));
  gh.lazySingleton<_i67.BottomTabCubit>(() => _i67.BottomTabCubit(
      get<_i53.IOrderRepository>(), get<_i49.ICreditRepository>()));
  gh.factory<_i68.CreditBloc>(
      () => _i68.CreditBloc(get<_i49.ICreditRepository>()));
  gh.lazySingleton<_i69.HomeBloc>(
      () => _i69.HomeBloc(get<_i51.IHomeRepository>()));
  gh.factory<_i70.HomeUserBloc>(() => _i70.HomeUserBloc(
      get<_i40.UserRepository>(),
      get<_i53.IOrderRepository>(),
