...
import 'package:onesignal_flutter/onesignal_flutter.dart' as _i27;
...
import 'domain/notification/i_notification_repository.dart' as _i25;
...
import 'infrastructure/notification/notification_repository.dart' as _i26;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  await gh.lazySingletonAsync<_i20.Dio>(
      () => registerModule.dioDev(get<_i3.Alice>(), get<_i14.IStorage>()),
      registerFor: {_dev},
      preResolve: true);
  await gh.lazySingletonAsync<_i20.Dio>(
      () => registerModule.dio(get<_i14.IStorage>()),
      registerFor: {_prod},
      preResolve: true);
  ...
  gh.lazySingleton<_i23.INetworkService>(() => _i24.NetworkService(
      ...
      get<_i6.Env>()));
  gh.lazySingleton<_i25.INotificationRepository>(() =>
  ...
  gh.lazySingleton<_i28.IProfileRepository>(() =>
      _i29.ProfileRepository(get<_i23.INetworkService>(), get<_i11.Logger>()));
  gh.factory<_i30.MapApi>(() => _i30.MapApi(get<_i23.INetworkService>()));
  gh.factory<_i31.MapRepository>(() => _i31.MapRepository(get<_i30.MapApi>()));
  gh.factory<_i32.NotificationBloc>(
      () => _i32.NotificationBloc(get<_i25.INotificationRepository>()));
  gh.factory<_i33.OrderApi>(
      () => _i33.OrderApi(get<_i23.INetworkService>(), get<_i14.IStorage>()));
  ...
  gh.factory<_i36.OrderRepository>(
      () => _i36.OrderRepository(get<_i33.OrderApi>(), get<_i16.OrderLocal>()));
  gh.factory<_i37.PostApi>(() => _i37.PostApi(get<_i23.INetworkService>()));
  gh.factory<_i38.ProfileBloc>(
      () => _i38.ProfileBloc(get<_i28.IProfileRepository>()));
  gh.factory<_i39.TransactionApi>(
      () => _i39.TransactionApi(get<_i23.INetworkService>()));
  gh.factory<_i40.TransactionRepository>(
      () => _i40.TransactionRepository(get<_i39.TransactionApi>()));
  gh.factory<_i41.UserApi>(
      () => _i41.UserApi(get<_i23.INetworkService>(), get<_i14.IStorage>()));
  gh.factory<_i42.UserRepository>(
      () => _i42.UserRepository(get<_i41.UserApi>(), get<_i17.UserLocal>()));
  ...
  gh.factory<_i44.AddressMapBloc>(() => _i44.AddressMapBloc(
      get<_i42.UserRepository>(), get<_i31.MapRepository>()));
  gh.factory<_i45.AuthApi>(() => _i45.AuthApi(get<_i23.INetworkService>()));
  gh.factory<_i46.AuthRepository>(
      () => _i46.AuthRepository(get<_i45.AuthApi>()));
  gh.factory<_i47.DigiLocaleBloc>(
      () => _i47.DigiLocaleBloc(get<_i21.IDigiLocaleRepository>()));
  ...
  gh.lazySingleton<_i52.ICreditRepository>(() =>
      _i53.CreditRepository(get<_i23.INetworkService>(), get<_i11.Logger>()));
  ...
  gh.factory<_i59.TopUpCreditBloc>(() => _i59.TopUpCreditBloc(
      get<_i52.ICreditRepository>(), get<_i14.IStorage>()));
  ...
  gh.factory<_i63.AuthBloc>(() => _i63.AuthBloc(
      get<_i50.IAuthFacade>(), get<_i25.INotificationRepository>()));
