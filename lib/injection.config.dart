...
import 'infrastructure/core/register_module.dart' as _i44;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i39.LoginBloc>(() => _i39.LoginBloc(get<_i37.IAuthFacade>()));
  gh.factory<_i40.OrderBloc>(() =>
      _i40.OrderBloc(get<_i27.OrderRepository>(), get<_i31.UserRepository>()));
  gh.factory<_i41.RegisterBloc>(
      () => _i41.RegisterBloc(get<_i37.IAuthFacade>()));
  gh.factory<_i42.ValidateOtpBloc>(
      () => _i42.ValidateOtpBloc(get<_i37.IAuthFacade>(), get<_i13.Logger>()));
  gh.factory<_i43.AuthBloc>(() => _i43.AuthBloc(get<_i37.IAuthFacade>()));
  return get;
}
