...
class CateringListProductCartWidget extends StatefulWidget {
...
class _ListProductCartWidgetState extends State<CateringListProductCartWidget> {
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        if (productCart.amount < productCart.price) {
          price = (productCart.amount + modifierTotalPrice) * productCart.qty;
          //beforePrice = widget.data[index]["detail"]["originalPrice"];
        } else {
          price = (productCart.price + modifierTotalPrice) * productCart.qty;
        }
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                      "Rp." +
                                          Utils.formatRupiah(price.toString()),
                                      softWrap: false,
                                      maxLines: 2,
                                      overflow: TextOverflow.ellipsis,
                            ...
                            if (productItem.limit == productCart.qty)
                              Container(
                                width: double.infinity,
                                padding: EdgeInsets.all(5),
                                child: Text(
                                  I10n.current.product_detail_max_item,
                                  style: AppFont.textBlack10Regular.copyWith(
