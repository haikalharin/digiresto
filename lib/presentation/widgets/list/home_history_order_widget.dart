...
class ListHomeHistoryOrderWidget extends StatefulWidget {
  ...
  const ListHomeHistoryOrderWidget(
      {Key? key,
      required this.data,
  ...
  @override
  _ListHomeHistoryOrderWidgetState createState() =>
      _ListHomeHistoryOrderWidgetState();
}

class _ListHomeHistoryOrderWidgetState
    extends State<ListHomeHistoryOrderWidget> {
    ...
    return Container(
        ...
        child: GridView.count(
          ...
          children: List.generate(widget.data.length, (index) {
            // _userStore?.setRandomCacheImage(widget.data[index].items![0].img!,
            //     widget.data[index].orderId.toString());
            // String defaultImage = _userStore!
            //     .getRandomCacheImage(widget.data[index].orderId.toString());
                ...
                if (widget.data[index].outlet!.isOwnerLoggedIn!) {
                  _orderMethodPopup.showMyDialog(
                      context,
                      {
                        ...
                        "merchantName":
                            widget.data[index].outlet!.merchantName.toString(),
                        "orderMethod":
                            widget.data[index].outlet!.orderMethod!.defaultList,
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        widget.data[index].outlet!.merchantName!.toString() +
                            " - " +
                            widget.data[index].outlet!.detail!.name.toString(),
                        maxLines: 2,
