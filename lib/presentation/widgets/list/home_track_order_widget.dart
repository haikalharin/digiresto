    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            List<dynamic> status =
                data[index].deliveryDetail!.containsKey("status")
                    ? data[index].deliveryDetail!["status"]
                    : [];
            String textStatus =
                status.length > 0 ? status[0]["state"] : "Menunggu";
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            alignment: Alignment.centerLeft,
                            child: Text(
                              data[index].outlet!.detail!.name.toString(),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                fontFamily: "roboto",
                          ...
                          Container(
                            ...
                            alignment: Alignment.centerLeft,
                            child: Text(
                              data[index].outlet!.merchantName.toString(),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                fontFamily: "roboto",
