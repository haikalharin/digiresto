...
import 'package:digiresto/presentation/home_new/list_catering_page/list_menu_catering_page.dart';
                  ...
                  Expanded(
                    child:  ListView(
                      children: List.generate(
                        ...
                        (index) {
                          var _data = state.outletCatering[index];
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Container(
