          ...
          child: Row(
            children: [
              Padding(
                ...
                child: new Icon(Icons.add, color: AppColors.red, size: 28.0),
              ),
              Text("Add New",
                  style: TextStyle(
                    fontFamily: "roboto",
                ...
                Row(
                  ...
                  children: [
                    new IconButton(
                        ...
                        onPressed: () {
                          // if (_userStore.activeHistoryScreen ==
                          //     'home.address') {
                          //   Navigator.of(context)
                          //       .pushNamed(Routes.home_all_address);
                          // } else if (_userStore.activeHistoryScreen ==
                          //     'profile.address') {
