import 'package:boilerplate/models/transaction/transaction_history_item_modifier.dart';
...
class TransactionHistoryItem {
  ...
  factory TransactionHistoryItem.create(Map<String, dynamic> object) {
    return TransactionHistoryItem(
      ...
      modifiers: List<TransactionHistoryItemModifier>.from(object['modifiers'].map((data) => TransactionHistoryItemModifier.create(data))),
